...
var file = fs.createWriteStream('ContactDescription.txt');
...
conn.login(username, password, function(err, userInfo) {
  ...
  // console.log('Org ID: ' + userInfo.organizationId);
	...
	conn.sobject('Contact').describe(function(err, meta) {
		...
		console.log('Describing Contact object...');
		...
		console.log('Successfully described Contact to ContactDescription.txt.');
	});
