...
var file = fs.createWriteStream('OpportunityDescription.txt');
...
conn.login(username, password, function(err, userInfo) {
  ...
  // console.log('Org ID: ' + userInfo.organizationId);
	...
	conn.sobject('Opportunity').describe(function(err, meta) {
		...
		console.log('Describing Opportunity object...');
		...
		console.log('Successfully described Opportunity to OpportunityDescription.txt.');
	});
